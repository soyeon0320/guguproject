...
.direct-chat-primary{height:100%;  width: auto; min-width: 500px; float:none; margin: auto; margin-top: 0px; margin-bottom: 0px;}
                ...
                <div class="direct-chat-messages">
                  ...
                  <div class="direct-chat-msg">
                    ...
                    <div class="direct-chat-text">
                      	...
                      	문의가 많을 경우 곧바로 채팅이 시작되지 않을 수 있으니 이점 양해 바랍니다.
                    </div>
...
function printAdminMsg(message) {
...
webSocket.onmessage = function (message) {
	if(message.data == "overConnect"){
		alert("현재 문의량이 많습니다. 잠시후에 이용해주세요.");
		window.close();
	}else{
		printAdminMsg(message.data);
	}
}
