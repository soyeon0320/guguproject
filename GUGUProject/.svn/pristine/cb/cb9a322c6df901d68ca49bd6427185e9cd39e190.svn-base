...
<!-- 		<div class="nav-in"> -->
			...
			<button type="button" style="float: right; margin-right: 3%;" class="mb-2 mr-2 btn-transition btn btn-outline-primary" onclick="location.href='/GUGUProject/jobnews/insert.do';">글 등록</button>
...
<nav>
  ...
  %>
    <a class="nav-item nav-link<%if(gubun.equals("NEWS")){ %> active<%} %>" id="nav-home-tab" data-toggle="tab" href="/GUGUProject/jobnews/managerlist.do?GUBUN=NEWS" role="tab" aria-controls="nav-home" aria-selected="true">뉴스</a>
    <a class="nav-item nav-link<%if(gubun.equals("TIPS")){ %> active<%} %>" id="nav-profile-tab" data-toggle="tab" href="/GUGUProject/jobnews/managerlist.do?GUBUN=TIPS" role="tab" aria-controls="nav-profile" aria-selected="false">취업팁</a>
    <a class="nav-item nav-link<%if(gubun.equals("SISA")){ %> active<%} %>" id="nav-contact-tab" data-toggle="tab" href="/GUGUProject/jobnews/managerlist.do?GUBUN=SISA" role="tab" aria-controls="nav-contact" aria-selected="false">시사</a>
  </div>
</nav>
       ...
       %>
        <div class="productBox">
			...
			<button type="button" class="mb-2 mr-2 btn-transition btn btn-outline-primary"
       				 onclick="location.href='/GUGUProject/jobnews/update.do?jobNewsCode=<%=jv.getJobNewsCode()%>';">수정</button>
			
			<button type="button" class="mb-2 mr-2 btn-transition btn btn-outline-primary"
       				 onclick="location.href='/GUGUProject/jobnews/delete.do?jobNewsCode=<%=jv.getJobNewsCode()%>';">삭제</button>
