	                ...
	                <div class="card-body">
	                	<h3 class="card-title" style="text-align: center;">기업 등록</h3>
	                        <div class="position-relative form-group">
	                        	<label>제목</label>
	                        	<input name="title" id="title" type="text" class="form-control" maxlength="330">
	                        </div>
	             
	                        <div class="position-relative form-group">
								<label>기업명</label>
		                        <input name="name" id="name" type="text" class="form-control" maxlength="330">
	                        </div>
	                        
	                        <div class="position-relative form-group" style="width: 45%; float: left;">
								<label>경력</label>
		                        <input name="career" id="career" type="text" class="form-control" maxlength="330">
	                        </div>
	             
	                        <div class="position-relative form-group" style="width: 45%; float: right;">
								<label>학력</label>
		                        <input name="educstion" id="educstion" type="text" class="form-control" maxlength="330">
	                        </div>
	             
	                        <div class="position-relative form-group" style="width: 45%; float: left;">
								<label>고용형태</label>
		                        <input name="employment" id="employment" type="text" class="form-control" maxlength="330">
	                        </div>
	             
	                        <div class="position-relative form-group" style="width: 45%; float: right;">
								<label>급여</label>
		                        <input name="salary" id="salary" type="text" class="form-control" maxlength="330">
	                        </div>
	             
	                        <div class="position-relative form-group" style="width: 45%; float: left;" >
								<label>지역</label>
		                        <input name="area" id="area" type="text" class="form-control" maxlength="330">
	                        </div>
	             
	                        <div class="position-relative form-group" style="width: 45%; float: right;">
								<label>산업(업종)</label>
		                        <input name="business" id="business" type="text" class="form-control" maxlength="330">
	                        </div>
	             
	                        <div class="position-relative form-group" style="width: 45%;float: left;">
								<label>사원수</label>
		                        <input name="employees" id="employees" type="text" class="form-control" maxlength="3800">
	                        </div>
	             
	                        <div class="position-relative form-group" style="width: 45%; float: right;">
								<label>기업형태</label>
		                        <input name="estab" id="estab" type="text" class="form-control" maxlength="330">
	                        </div>
	             
<!-- 	                        <div class="position-relative form-group" style="width: 100%;"> -->
								<label style="margin-left: 2%">홈페이지</label>
		                        <input name="homepage" id="hemepage" type="text" class="form-control" maxlength="650">
<!-- 	                        </div> -->
	                        ...
	                        <div class="position-relative form-group" style="width: 45%; float: right; margin-bottom: 2%; margin-top: 4%;">
								<label>마감일</label>
		                       	<input type="datetime-local" name="lastdate" id="lastdate"><br>
	                        </div>
